...
GO
CREATE PROCEDURE [dbo].[spPAY_RptGetDailyAttendanceCalendar]
...
AND (ISNULL(C51.DORelieve,'''')<>'''' OR ISNULL(CONVERT(DATETIME,C51.DORelieve),''01-JAN-1990'')<='''+CONVERT(NVARCHAR,@ToDate)+''')  '
