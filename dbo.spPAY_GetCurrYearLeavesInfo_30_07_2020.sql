...
GO
CREATE PROCEDURE [dbo].[spPAY_GetCurrYearLeavesInfo_30_07_2020]
	...
	EXEC [spPAY_EXTGetLeaveyearDates] @FromDate,@ALStartMonthYear OUTPUT,@ALEndMonthYear OUTPUT
		...
		END
			...
			BEGIN			
				...
				SELECT @CurrYearLeavesTakenOP=COUNT(*) FROM @DATESCOUNT WHERE FLAG=1 AND count>=1 and isnull(IncExc,'')=''
