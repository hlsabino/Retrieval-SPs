...
GO
CREATE PROCEDURE [dbo].[spADM_GetAllListViewsDef]
	@UserID [int] = 0,
	@LangID [int] = 1
...
SET NOCOUNT ON  
   ...
   SELECT a.[ListViewID],a.LISTVIEWNAME,a.[CostCenterID],a.[ListViewTypeID],a.[SearchFilter]
      ,a.[RoleID],a.[UserID],a.[IsUserDefined],b.ColumnType,b.IsParent ,b.IsCode,a.IgnoreSpecial
      ,SearchColID,SearchColName, LVPopUp,ListViewPageSize,ListViewDelaytime 
      ,case when b.CostCenterColID <-50000 THEN f.Name ELSE D.ResourceData END as ResourceData,b.CostCenterColID,SysColumnName,b.ColumnOrder,b.ColumnWidth,b.Description,b.DocumentsList,c.ColumnCostCenterID
   ...
   LEFT JOIN ADM_Features F  WITH(NOLOCK) ON b.CostCenterColID <-50000 and F.FeatureID=(b.CostCenterColID*-1)
    order by a.[ListViewID],b.ColumnOrder
